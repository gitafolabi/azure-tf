resource "azurerm_application_gateway" "app_gateway" {
  ...
  dynamic "frontend_port" {
    ...
    content {
      name = lookup(frontend_port.value, "name", "afolabi")
  ...
  */
  ...
  dynamic "backend_http_settings" {
    ...
    content {
      name       = lookup(backend_http_settings.value, "name", "afolabi")
      path       = lookup(backend_http_settings.value, "path", "/")
      probe_name = lookup(backend_http_settings.value, "probe_name", "afolabi")
      ...
      host_name                           = lookup(backend_http_settings.value, "host_name", "afolabi")
  ...
  dynamic "http_listener" {
    ...
    content {
      name                           = lookup(http_listener.value, "name", "afolabi")
      ...
      frontend_port_name             = lookup(http_listener.value, "frontend_port_name", "afolabi")
      protocol                       = lookup(http_listener.value, "protocol", "Http")
      ssl_certificate_name           = lookup(http_listener.value, "ssl_certificate_name", null)
      host_name                      = lookup(http_listener.value, "host_name", "afolabi")
  ...
  dynamic "backend_address_pool" {
    ...
    content {
      name  = lookup(backend_address_pool.value, "name", "afolabi")
      fqdns = lookup(backend_address_pool.value, "fqdns", ["afolabi"])
    }
  }
  ...
  dynamic "request_routing_rule" {
    ...
    content {
      name      = lookup(request_routing_rule.value, "name", "afolabi")
      rule_type = lookup(request_routing_rule.value, "rule_type", "Basic")

      http_listener_name          = lookup(request_routing_rule.value, "http_listener_name", lookup(request_routing_rule.value, "name", "afolabi"))
      backend_address_pool_name   = lookup(request_routing_rule.value, "backend_address_pool_name", lookup(request_routing_rule.value, "name", "afolabi"))
      backend_http_settings_name  = lookup(request_routing_rule.value, "backend_http_settings_name", lookup(request_routing_rule.value, "name", "afolabi"))
  ...
  dynamic "probe" {
    ...
    content {
      host                = lookup(probe.value, "host", "afolabi")
      interval            = lookup(probe.value, "interval", 30)
      name                = lookup(probe.value, "name", "afolabi")
